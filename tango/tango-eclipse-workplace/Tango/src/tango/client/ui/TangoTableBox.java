 ...
 */
public class TangoTableBox extends Composite{
	...
	public TangoTableBox(final TangoPanelTable panelTable){
		...
		rowBox.addKeyboardListener(new KeyboardListener(){
			public void onKeyPress(Widget sender, char keyCode, int modifiers) {
				if((int)keyCode == 13){	// Enter key pressed
					...
					if(checkText(wordPanelTable)) wordTangoMain.tangoButton.click();
	...
	public boolean checkText(TangoPanelTable wordPanelTable){
		try{
